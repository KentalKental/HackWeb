function Footer() {
    return (
        <>
            <div className="container-expand  d-flex justify-content-around p-4 fixed-bottom" style={{ background: "#8f83ff", color: "white", borderTopLeftRadius: "150px", borderTopRightRadius: "150px" }}>
                <div>
