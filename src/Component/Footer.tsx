...
const Footer = () => {
  return (
    <>
     <footer className="mx-auto relative z-10 bg-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px] w-[96%] rounded-t-[16px] border-[#6610F250] border-2 items-center">
        <div className="" />
